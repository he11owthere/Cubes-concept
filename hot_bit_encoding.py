descriptors = ['has_bill_shape::curved_(up_or_down)',
...
descriptor_index = {descriptor: index for index, descriptor in enumerate(unique_descriptors)}

hot_bit_encodings = []
output = []

for i, descriptor in enumerate(descriptors):
    encoding = [0] * len(unique_descriptors)
    encoding[i] = 1
    hot_bit_encodings.append(encoding)
    output.append((descriptor, encoding))

for descriptor, encoding in output:
    print(descriptor, encoding)
